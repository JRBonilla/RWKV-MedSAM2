...
class SAM2VideoPredictor(SAM2Base):
    ...
    # Train_init_state and val_init_state lifted directly from Medical SAM-2.
    # https://github.com/SuperMedIntel/Medical-SAM2/blob/main/sam2_train/sam2_video_predictor.py    @torch.inference_mode()
    def val_init_state(
        self,
        imgs_tensor,
        video_height=None,
