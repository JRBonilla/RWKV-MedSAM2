...
def parse_args(argv=None):
    ...
    parser.add_argument("--metadata-csv", type=Path, default=Path("F:/Datasets/datasets.csv"))
    parser.add_argument("--groups-dir", type=Path, default=Path("F:/DatasetIndexes/Groups"))
    parser.add_argument("--data-root", type=Path, default=Path("F:/Datasets"))
    parser.add_argument("--output-dir", type=Path, default=Path("F:/DatasetIndexes/CTStats_v2"))
